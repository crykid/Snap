...
public final class ApplicationUtils {
    ...
    public static boolean isRunningOnTop(Activity activity) {
        return activity.getClass().getName().equals(getRunningActivityName(activity));
    }
